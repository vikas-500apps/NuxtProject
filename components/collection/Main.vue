<template>
    ...
    <div v-else>
        ...
        <div class="grid grid-rows-3 grid-flow-col grid-cols-4 border w-[80vw] mx-auto my-5 rounded-lg pr-[4px]">
            ...
            <CollectionEdit v-show="editTemplate && templates.length" :key="render" :template="currentTemplate" :url="url"
                :project-id="projectId" :share-type="shareType" :entity="entity" :is-active="isActive" @edit="edit" />
